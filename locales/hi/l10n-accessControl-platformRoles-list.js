...
module.exports = {
  ...
  ROLE_USERS_MANAGER: 'Xcloud प्लेटफॉर्म पर सभी यूजर्स का प्रभंधन करें।',
  ROLE_WORKSPACES_MANAGER: 'Xcloud प्लेटफॉर्म पर सभी वर्कस्पेसेस का प्रभंधन करें।',
  ROLE_PLATFORM_ADMIN: 'Xcloud प्लेटफॉर्म पर सभी संसाधनों का प्रबंधन करें।',
  ...
  PERMISSION_PLATFORM_SETTINGS_MANAGEMENT_DESC: 'View and edit settings of the Xcloud platform.'
};